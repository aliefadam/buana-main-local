	...
	module.exports = {
		...
		data: function() {
			return {
				...
				headers: [{
					...
					"filter": true,
					"groupable": false,
					"url": App.url+"bom/purchase_order_item",
					"searchby": ['item_no', 'item_name'],
					"formatter": ['item_id', ['item_no', 'item_name']],
					"options": {
						"filter": {
						},
						"filterType": {
		...
		methods: {
			...
			onVisible: function(isVisible, e) {
				...
				if(App.page().selected)
					self.headers[2].options.filter.purchase_order_id = App.page().selected.po_id
			},
		},
		mounted: function() {
