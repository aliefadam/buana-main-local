				...
				items: [
                    {
						...
						children: [{
							name: 'Active',
							loadWithBase: '/purchasingdev/bomdev/purchasing/active'
						}, 
                        {
							name: 'History',
							loadWithBase: '/purchasingdev/bomdev/purchasing/history'
						},
                        {
							name: 'Monitoring',
							loadWithBase: '/purchasingdev/bomdev/purchasing/monitoring'
						}]
					},
                    {
						name: 'Report',
						children: [{
							name: 'PO Payment',
							loadWithBase: '/purchasingdev/bomdev/purchasing/popayment'
						}]
					},
				]
			}
