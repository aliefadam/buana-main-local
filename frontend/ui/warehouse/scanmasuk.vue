        ...
        methods: {
            ...
            onSuccess: async function(data) {
                ...
                try {
                    ...
                    if(self.active=='item'){ 
                        if(data.decodedText.match(/^bmt.item.\d+/i)==null)
                            throw 'Item is not valid!'
                        data.decodedText = data.decodedText.split(/^bmt.item./i)[1]
                    }
                    if(self.active=='rack'){ 
                        if(data.decodedText.match(/^bmt.rack.\d+/i)==null)
                            throw 'Rack is not valid!'
                        data.decodedText = data.decodedText.split(/^bmt.rack./i)[1]
                    }
