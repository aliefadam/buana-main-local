  ...
  >
    ...
    >
        ...
        <v-row>
          <v-col cols="3">
            <v-card
              ...
              max-width="344"
              outlined
              title="Total PO with Status Approved"
            >
          ...
          <v-col cols="3">
            <v-card
              ...
              max-width="344"
              outlined
              title="Total PO with Status Rejected"
            >
              <v-list-item three-line>
                <v-list-item-content>
                  <div class="text-overline mb-4" style="font-weight: bold">
          ...
          <v-col cols="3">
            <v-card
              ...
              max-width="344"
              outlined
              title="Total PO with Status All Items received"
            >
              <v-list-item three-line>
                <v-list-item-content>
                  <div class="text-overline mb-4" style="font-weight: bold">
      ...
      <template v-slot:title-body v-if="$refs.template">
        <b>PO History: </b>{{ $refs.template.itemsTotal }}
      </template>
  ...
  methods: {
    ...
    async getData() {
      try {
        ...
        self.total_approved_po = data.data.data[0].po_approved;
        self.total_rejected_po = data.data.data[0].po_rejected;
        self.total_completed_po = data.data.data[0].po_completed;
      } catch (e) {}
    },
  },
  mounted: function () {
