      ...
      Object.keys(groupedIds).map((price) => {
        ...
        groupedIds[price].map((subledgerId) => {
          ...
          if (projectType === "operational") {
            ...
            groupedPersediaanIds[price].push(subledgerId);
          } else {
            ...
            axios
              .get(
                "https://panel.buanamultiteknik.com/api/budget/persediaan/summary",
                {
                  params: {
                    price: price,
                    subledger_id: groupedPersediaanIds[price].join(","),
                  },
                },
              )
              .then((budgetRes) => {
                ...
                budgetData.map((d) => {
                  var subledgerId =
                    d.subledger_id !== undefined ? d.subledger_id : d.id;
                  if (
                    (subledgerId === undefined || subledgerId === null) &&
                    groupedPersediaanIds[price].length === 1
                  ) {
