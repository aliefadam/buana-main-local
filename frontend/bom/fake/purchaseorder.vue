...
module.exports = {
    ...
    components: {
        ...
        'report': 'url:ui/bom/fake/report/purchaseorder.vue',
        'purchase-item-group': 'url:ui/bom/fake/purchaseorderitemgroup.vue',
        'po-rev-history': 'url:ui/bom/fake/purchaseorder_revisi.vue',
        'po-comment': 'url:ui/bom/fake/comment.vue',
    ...
    methods: {
        ...
        saveFile: async function () {
            ...
            var res = await axios.post(App.url + 'fake/purchaseorder/sendpo', formData,
                {
                    headers: {
        ...
        revision: async function () {
            ...
            if (!q)
                ...
                try {
                    var r = await axios.get(App.url + 'fake/purchaseorder/revisi', {
                        params: {
                            id: self.selected.id,
        ...
        askAprpovalRevision: async function () {
            ...
            if (!q)
                ...
                try {
                    var r = await axios.get(App.url + 'fake/purchaseorder/askapprovalrevisi', {
                        params: {
                            id: self.selected.id,
        ...
        cancel: async function () {
            ...
            if (!q)
                ...
                try {
                    var r = await axios.get(App.url + 'fake/purchaseorder/cancel', {
                        params: {
        ...
        onSelectedRow: async function (val) {
            ...
            if (val === undefined) {
                ...
                try {
                    ...
                    const response = await fetch(`api/fake/purchaseorder/getdataexistpaymentlist?id=${val.id}`);
                    const data = await response.json();
        ...
        askApproval: async function (val) {
            ...
            if (!c) return true;
            if (self.selected.approved == 0) {
                var r = await axios.put(App.url + 'fake/purchaseorder', {
                    approved: 1,
                    pk: self.selected.id,
        ...
        openReport: function () {
            ...
            window.open('https://main.buanamultiteknik.com/api/data/reportpo?fake=1&id=' + self.selected.id + '&filename=' + name + '&idx=' + randomid)
        ...
        openReport2: function () {
            ...
            var name = self.selected.po_no.replace(/\//g, '_').replace(/\-/g, '_')
            var randomid = randomId()
            window.open('https://main.buanamultiteknik.com/api/data/reportpo2?fake=1&id=' + self.selected.id + '&filename=' + name + '&idx=' + randomid)
        ...
        openReportNoPrice: function () {
            ...
            var name = self.selected.po_no.replace(/\//g, '_').replace(/\-/g, '_')
            var randomid = randomId()
            window.open('https://main.buanamultiteknik.com/api/data/reportponoprice?fake=1&id=' + self.selected.id + '&filename=' + name + '&idx=' + randomid)
        },
        remove(item) {
        ...
        sendEmail: async function () {
            ...
            try {
                if (self.toSelected.length == 0)
                    ...
                    var r = await axios.post(App.url + 'fake/purchaseorder/emailsupplier', {
        ...
        sendEmail2: async function () {
            ...
            try {
                if (self.toSelected.length == 0)
                    ...
                    var r = await axios.post(App.url + 'fake/purchaseorder/autoemailsupplier', {
                        to: self.toSelected.join(';;'),
                        po_id: self.selected.id,
                        supplier_id: self.selected.supplier_id,
                        cc: self.ccSelected.join(';;')
