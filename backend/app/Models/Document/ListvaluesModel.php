...
class ListvaluesModel extends Model
{
    protected $table = 'document_list_values';
    protected $returnType     = 'object';
    protected $primaryKey = 'document_list_value_id';
    protected $allowedFields = ["document_list_value_id","document_list_id","text","value","datatype","created_date","created_by","modified_date","modified_by","flag"];
