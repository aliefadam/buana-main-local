...
class ProjectitemModel extends Model
{
    ...
    protected $allowedFields = ["id","project_id","name","keterangan","created_by","created_date","flag","modified_by","modified_date","sub_number"];
    ...
    function read($json){
        ...
        if(trim($where)=='')
            ...
            $where .= ' and s.flag = 1';
		$q = "select mp.project_no, mp.project_name,
