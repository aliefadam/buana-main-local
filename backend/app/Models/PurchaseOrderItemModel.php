...
class PurchaseOrderItemModel extends Model
{
    ...
    "purchase_order_id",
    "bom_id",
    "price_per_item", "order_qty", "item_id", "active", 'flag', 'allocation', 'complete_qty', 'created_date', 'created_by', 'modified_date', 'modified_by','order_no', 'subledger_id', 'use_ppn', 'use_pph', 'ppn_value', 'pph_value'
];
