...
class PartlistrebuildModel extends Model
{
    protected $table = 'm_partlist_rebuild';
    protected $returnType     = 'object';
    protected $primaryKey = 'id';
    protected $allowedFields = ["id", "sub_assembly", "sub_assembly_desc", "part_number", "part_number_desc", "article_number", "section", "application", "index_no", "qty", "class", "uom", "brand", "created_by", "created_date", "modified_by", "modified_date", "is_part", "flag"];
    ...
    function read($json){
        ...
        concat(s.part_number,' - ', s.part_number_desc) as partno_info,
        ...
        if(isset($json->partno))
            $fields="distinct part_number, partno_info";
