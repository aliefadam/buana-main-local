...
class PosakunModel extends Model
{
    protected $table = 'pos_akun';
    protected $returnType     = 'object';
    protected $primaryKey = 'kode';
    protected $allowedFields = ["kode","nama","tipe_akun","tipe","created_by","created_date","modified_by","modified_date","flag"];
