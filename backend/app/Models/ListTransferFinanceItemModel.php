...
class ListTransferItemFinanceModel extends Model
{
    ...
    function read($json){
		...
		$q2 = "
		select ".join(',', array_map(array($this, 'addPrefix'), $this->allowedFields)).", i.payment_value, i.total_price, i.invoice_no,  i.as_reference, i.invoice_doc_url, i.uraian, i.payment_pct, i.proof_of_transfer, i.is_paid, i.paid_date, i.debited_acc, i.transfer_type, i.transaction_code, i.reimburse_id,
