...
{
    protected $table = 'bom_receive_header';
    protected $returnType     = 'object';
    protected $primaryKey = 'id';
    protected $allowedFields = ["id","bom_no","description","project_id", "isPack", "flag", "created_by","created_date","modified_by","modified_date","koli","machine_name"];
    ...
    function read($json){
        ...
        if(trim($where)=='')
            ...
            $where .= ' and s.flag = 1';
		$q = "select 
			c.name as created_by_name, m.name as modified_by_name, p.project_no,p.project_name, 
