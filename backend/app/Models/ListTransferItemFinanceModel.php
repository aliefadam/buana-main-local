...
class ListTransferItemFinanceModel extends Model
{
    ...
    function read($json){
		...
		left join rfq_header rfq on rfq.id = coalesce(pr.rfq_id, p.rfq_id)";
        
		$q2 = "
		select ".join(',', array_map(array($this, 'addPrefix'), $this->allowedFields)).", i.payment_value, i.invoice_no, i.ref_invoice_no, i.ref_invoice_no as tef_invoice_no, i.invoice_date, i.invoice_doc_url, i.as_reference, i.uraian, i.payment_pct, i.proof_of_transfer, i.is_paid, i.paid_date, i.debited_acc, i.transfer_type, i.transaction_code, i.reimburse_id,
