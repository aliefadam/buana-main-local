...
class SubassemblyModel extends Model
{
    protected $table = 'subassembly';
    protected $returnType     = 'object';
    protected $primaryKey = 'id';
    protected $allowedFields = ["id","description", "type_subassy", "part_number","art_num", "sub_assembly_id","sub_assembly","sub_assembly_desc","index_no","aplikasi","qty","uom","brand", "part_no_china", "flag"];
