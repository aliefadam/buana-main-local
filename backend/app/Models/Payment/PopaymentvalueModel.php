...
class PopaymentvalueModel extends Model
{
    protected $table = 'po_payment_value';
    protected $returnType     = 'object';
    protected $primaryKey = 'id';
    protected $allowedFields = ["id","value_old","value_new","created_date","created_by","po_id","invoice_id","payment_id"];
