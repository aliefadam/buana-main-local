<?php namespace App\Controllers\Machine\Gb;
 
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\API\ResponseTrait;
use App\Models\Machine\Gb\ArduinoModel;
 
class Arduino extends ResourceController
{
    use ResponseTrait;
    ...
    public function createget($json)
    {
        $model = new ArduinoModel();
        //$json = $this->request->getJSON();
