...
use App\Models\Barcode\NoinputModel;
 
class Noinput extends ResourceController
{
    use ResponseTrait;
    ...
    public function index()
    {
        try {
            ...
            if($this->request->getMethod() == 'put'){
                ...
                $json = $_REQUEST;
                $json["filter"] = json_decode(json_encode($json["filter"] ?? json_decode ("{}")), true);
                $json["filterType"] = json_decode(json_encode($json["filterType"] ?? json_decode ("{}")), true);
                $json["filterCondition"] = json_decode(json_encode($json["filterCondition"] ?? json_decode ("{}")), true);
                $json = (Object) $json;
	...
	public function alreadytracked()
	{
		...
		$json = $_REQUEST;
                $json = (Object) $json;
		$data = $model->alreadytracked($json);
