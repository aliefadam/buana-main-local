...
use App\Models\Transaction\ReceivescanModel;
 
class Receivescan extends ResourceController
{
    use ResponseTrait;
    ...
    public function create()
    {
		...
		$s = $session->get();
		if(isset($data['code']))
				$data['code'] = urldecode($data['code']);
			if(isset($data['qty']))
				$data['qty'] = urldecode($data['qty']);
			if(isset($data['location']))
				$data['location'] = urldecode($data['location']);
			if(isset($data['flag']))
				$data['flag'] = 1;
