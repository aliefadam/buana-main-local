...
use App\Models\Monitoring\ListporeadyforpoModel;
 
class Listporeadyforpo extends ResourceController
{
    use ResponseTrait;
    ...
    public function index()
    {
        try {
            ...
            $model = new ListporeadyforpoModel();
