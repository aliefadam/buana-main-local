...
use App\Models\Monitoring\ListrfqreadyforprModel;
 
class Listrfqreadyforpr extends ResourceController
{
    use ResponseTrait;
    ...
    public function index()
    {
        try {
            ...
            $model = new ListrfqreadyforprModel();
