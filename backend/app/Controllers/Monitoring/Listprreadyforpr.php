...
use App\Models\Monitoring\ListprreadyforprModel;
 
class Listprreadyforpr extends ResourceController
{
    use ResponseTrait;
    ...
    public function index()
    {
        try {
            ...
            $model = new ListprreadyforprModel();
