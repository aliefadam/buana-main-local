...
use App\Models\PurchaseOrderItemGroupHistoryModel;
 
class Purchase_order_item_group_history extends ResourceController
{
    use ResponseTrait;
    ...
    {
        try {
            $model = new PurchaseOrderItemGroupHistoryModel();
    ...
    public function addpr(){
        ...
        $res = $model->read_pr_part($json->pr_part_id);
