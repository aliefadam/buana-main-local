...
class GeneralModel extends Model
{
    ...
    protected $allowedFields = ['id', 'value', 'text', 'category', 'description', 'flag'];
    ...
    function read($json){
        ...
        $query = $db->query("select ".join(',', array_map(array($this, 'addPrefix'), $this->allowedFields))." from $q limit $offset, $limit");
