...
{
    protected $table = 'fake_purchase_order';
    ...
    function read($json){
        ...
        if(trim($where)=='')
            ...
            i.grand_total_price, ms.email, rfq.rfq_no, pr.pr_no, pr.id as prr_id, i.grand_total_price+s.charge1+s.charge2-s.discount as grand_total,
