...
use App\Models\Monitoring\ListrfqquotationModel;
 
class Listrfqquotation extends ResourceController
{
    use ResponseTrait;
    ...
    public function index()
    {
        try {
            ...
            $model = new ListrfqquotationModel();
