...
use App\Models\Monitoring\ListrfqclarificationModel;
 
class Listrfqclarification extends ResourceController
{
    use ResponseTrait;
    ...
    public function index()
    {
        try {
            ...
            $model = new ListrfqclarificationModel();
            if($this->request->getMethod() == 'put'){
                ...
                $json = (Object) $json;
                $data = $model->clarificationRfq($json);
