...
class Purchase_order extends ResourceController
{
	...
	public function info(){
		...
		if($q[0]){
			...
			<tr><td><div style='min-width: 100px;'><b>Ask for approval date: </b></div></td><td>".$d->ask_approval_date."</td></tr>
			<tr><td><div style='min-width: 100px;'><b>Approved date: </b></div></td><td>".$d->approval_date."</td></tr>
			<tr><td><div style='min-width: 100px;'><b>Approved by: </b></div></td><td>".$d->approved_by_name."</td></tr>
			";
		}
        $response = [
            'status'   => $q[0],
