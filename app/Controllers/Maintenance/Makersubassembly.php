<?php namespace App\Controllers\Maintenance;
 
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\API\ResponseTrait;
use App\Models\Maintenance\MakersubassemblyModel;
 
class Makersubassembly extends ResourceController
{
    use ResponseTrait;
    ...
    {
        try {
            $model = new MakersubassemblyModel();
