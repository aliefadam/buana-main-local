      ...
      <template v-slot:expanded-item="props">
        ...
        >
          <subassy-item-group
            ...
            :key="props.item[itemKey]"
            :sel="{
              sub_assembly_id: props.item.id,
            }"
            name=""
            :data="{
              sub_assembly_id: props.item[itemKey],
            }"
          ></subassy-item-group>
        </td>
      </template>
...
module.exports = {
  ...
  creator: "",
  components: {
    "subassy-item-group": "url:ui/rebuildmachine/subassyitem.vue",
  },
  props: {
    value: undefined,
    data: {
